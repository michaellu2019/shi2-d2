...
const int ZMP_MPC_NUM_TIMESTEPS = 304; // number of time steps
const double ZMP_MPC_TIMESTEP_PERIOD_MS = FOOT_POSE_PUBLISHER_LOOP_PERIOD_MS; // MPC time step period in ms
...
double ZMP_STEP_HEIGHT_M = 20.0e-3;
double step_period_ms = 300;
